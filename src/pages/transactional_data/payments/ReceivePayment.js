        ...
        <div className="grid crud-demo">
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        <Column field="payment_no" header="Trx No" filter filterElement={expenseTypeFilterTemplate} sortable body={paymentVoucherBodyTemplate}  headerStyle={{ minWidth: '10rem' }}></Column>
